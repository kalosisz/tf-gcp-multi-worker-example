...
from trainer.data import (
    numeric_feature_descriptions, get_dataset, get_steps_per_epoch)
from trainer.model import create_model
from trainer.utils import save_model
...
def main(args):
    ...
    steps_per_epoch = get_steps_per_epoch(
        strategy, args.training_examples, args.train_batch_size)
    validation_steps = get_steps_per_epoch(
        strategy, args.validation_examples, args.train_batch_size)
